...
**
** Created: Sat Jul 12 19:20:38 2014
...
static const char qt_meta_stringdata_QSFcanvas[] = {
    ...
    "sendPadPos(float)\0sendStop(bool)\0"
    "takeContr(bool)\0receiveDM(DisplayManager&)\0"
    "switchMap(int)\0pause()\0desableLeft()\0"
    "desableRight()\0x,y\0updateView(int,int)\0"
};
...
void QSFcanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->sendPadPos((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 5: _t->sendStop((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->takeContr((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 7: _t->receiveDM((*reinterpret_cast< DisplayManager(*)>(_a[1]))); break;
        case 8: _t->switchMap((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 9: _t->pause(); break;
        case 10: _t->desableLeft(); break;
        case 11: _t->desableRight(); break;
        case 12: _t->updateView((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 4
void QSFcanvas::sendPadPos(float _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
