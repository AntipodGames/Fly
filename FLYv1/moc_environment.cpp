...
**
** Created: Sat Jul 12 19:20:39 2014
...
static const char qt_meta_stringdata_Environment[] = {
    ...
    "sendMort(int)\0sendScore(int)\0newLevel(int)\0"
    "endLvl(QString)\0run()\0pause()\0"
    "makeStop(bool)\0"
};
...
void Environment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->newLevel((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->endLvl((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 5: _t->run(); break;
        case 6: _t->pause(); break;
        case 7: _t->makeStop((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
