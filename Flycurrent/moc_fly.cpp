...
static const char qt_meta_stringdata_Fly[] = {
    ...
    "Left()\0Right()\0turn(float)\0"
    "posUpdate(float,float)\0Boost(bool)\0"
    "SlideMod(bool)\0takeControl(bool)\0"
    "wall()\0"
};
...
void Fly::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->posUpdate((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 7: _t->Boost((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 8: _t->SlideMod((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 9: _t->takeControl((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 10: _t->wall(); break;
        default: ;
        }
    }
}
